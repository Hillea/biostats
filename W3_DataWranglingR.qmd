...
::: aside
It is encouraged to use many line breaks for better readability. Check out the <u>[Tidyverse Style Guide](https://style.tidyverse.org/syntax.html#long-lines)</u> for suggestions.
:::
...
::: notes
The second table is the tidiest!
